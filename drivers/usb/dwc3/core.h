...
void __maybe_unused dwc3_gadget_usb3_phy_suspend(struct dwc3 *dwc, int suspend);
#else
...
static inline void dwc3_gadget_usb3_phy_suspend(struct dwc3 *dwc, int suspend) { }
