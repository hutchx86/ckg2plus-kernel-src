...
static inline void *ipc_router_create_log_ctx(char *name) { return NULL; }
static inline void ipc_router_log_ctx_init(void) { }
static inline void *ipc_router_get_log_ctx(char *sub_name) { return NULL; }
